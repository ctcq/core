...
class Storage extends DAV implements ISharedStorage {
	...
	public function checkStorageAvailability() {
		...
		try {
			if (!$this->propfind('', $strictNotFoundCheck=true)) {
				...
				if ($this->testRemote()) {
					...
					$this->logger->error(
						'Storage for external share {shareId} returns not found error and 
						likely has been removed with failed notification to this instance receipent',
						['shareId' => $this->getId()]);
			...
			$this->logger->error(
				'Storage for external share {shareId} returns auth error and 
				likely has been removed with failed notification to this instance receipent',
				['shareId' => $this->getId()]);
			$this->manager->removeShare($this->mountPoint);
			$this->manager->getMountManager()->removeMount($this->mountPoint);
